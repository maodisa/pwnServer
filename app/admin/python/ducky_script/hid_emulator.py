...
DUCKY_HID_MAPPING = {
    ...
    "3": (0x00, 0x20), "§": (0x00, 0x20), "4": (0x00, 0x21), "$": (0x02, 0x21),
    "5": (0x00, 0x22), "%": (0x02, 0x22), "6": (0x00, 0x23), "&": (0x02, 0x23),
    "7": (0x00, 0x24), "/": (0x02, 0x24), "8": (0x00, 0x25), "(": (0x02, 0x25),
    "9": (0x00, 0x26), ")": (0x02, 0x26), "0": (0x00, 0x27), "=": (0x02, 0x27),
    "?": (0x02, 0x38), "+": (0x02, 0x30), "*": (0x02, 0x37), "'": (0x00, 0x32),
    ",": (0x00, 0x36), ".": (0x00, 0x37), "-": (0x00, 0x38), "_": (0x02, 0x38),
    ":": (0x02, 0x33), ";": (0x00, 0x33), " ": (0x00, 0x2C), "ENTER": (0x00, 0x28),
    "ESC": (0x00, 0x29)
}
